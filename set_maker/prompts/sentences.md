...
You are in charge of creating a dataset for someone learning the language {{target_language}}, noting that their native language is {{native_language}}. This dataset will be passed into an educational app that teaches them the language (think Duolingo). For each word in the word bank, write a creative, natural sounding and interesting exert of ~2 sentences combining the word and others, ideally all from the word list. This means that you will have the same number of exerts as words in the word bank.
